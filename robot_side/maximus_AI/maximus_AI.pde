...
#pragma optsize+
    ...
    Serial1.begin(19200);                                  // Motion control serial port
...
void loop()
{
    ...
    if (((front_distance_down_right < 30) || ((front_distance_down_middle < 35) && (front_distance_down_middle > 5))
         || (front_distance_down_left < 30)) && (has_pawn == NO_PAWN)) {
